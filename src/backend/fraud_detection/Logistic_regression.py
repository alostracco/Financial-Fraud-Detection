...
def run_madlib_logistic_regression():
    ...
    with engine.connect() as connection:
        ...
        # Ensure our features view exists. If you haven't created it beforehand, run:

        connection.execute(text("CREATE OR REPLACE VIEW transactions_features AS SELECT (is_fraud = 1)::boolean AS is_fraud, ARRAY[transaction_time, amount, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15, v16, v17, v18, v19, v20, v21, v22, v23, v24, v25, v26, v27, v28 ]::double precision[] AS features FROM transactions;"))
        ...
        #predictions = connection.execute(text("SELECT * FROM predictions;")).fetchall() Uncomment this to see the prediction for each datapoint
        #print(predictions)
